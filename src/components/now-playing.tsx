                            ...
                            {track.image && (
                                <div className="mb-3 rounded-lg overflow-hidden ">
                                    <img
                                        src={track.image}
                                        alt={track.name}
                                        className="w-[24px] h-[24px] aspect-square object-cover"
                                    />
                                </div>
                            )}
                            <h3 className="font-semibold text-[9px] text-white line-clamp-2 group-hover:text-white/90 transition-colors">

                                {track.name}
                                <p className="text-[8px] text-white/60 group-hover:text-white/70 transition-colors">
                                    {track.artist}
                                </p>
                            </h3>
